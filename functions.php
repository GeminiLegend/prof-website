...
function loadCustomScripts(){
    ...
    if(is_page('My Blog')){
        ...
        wp_enqueue_script('oldjQuery', get_template_directory_uri() . '/js/magic-animations/js/jquery.1.10.2.min.js', array());
        wp_enqueue_script('magicAnimations', get_template_directory_uri() . '/js/magic-animations.js', array('oldjQuery'));
        wp_enqueue_style('magicAnimationsStyle', get_template_directory_uri() . '/js/magic-animations/css/magic.min.css', array());
        wp_enqueue_style('magicAnimationsMainStyle', get_template_directory_uri() . '/js/magic-animations/css/custom.css', array());

    } elseif(is_page('Showcase')){
        wp_enqueue_style('fancyBoxStyle', get_template_directory_uri() . '/js/fancyBox/source/jquery.fancybox.css', array());
        wp_enqueue_script('fancyBox', get_template_directory_uri() . '/js/fancyBox/source/jquery.fancybox.pack.js', array());
        wp_enqueue_script('fancyBoxHelper', get_template_directory_uri() . '/js/fancyBoxHelper.js', array('fancyBox'));

        wp_enqueue_style('elasticStackStyle', get_template_directory_uri() . '/js/ElasticStack/css/component.css', array());
        wp_enqueue_style('elasticStackStyleNormalize', get_template_directory_uri() . '/js/ElasticStack/css/normalize.css', array());
        wp_enqueue_script('draggabilly', get_template_directory_uri() . '/js/ElasticStack/js/draggabilly.pkgd.min.js', array());
        wp_enqueue_script('modernizr', get_template_directory_uri() . '/js/ElasticStack/js/modernizr.custom.js', array());
        wp_enqueue_script('elasticStack', get_template_directory_uri() . '/js/ElasticStack/js/elasticStack.js', array('draggabilly', 'modernizr'));
        wp_enqueue_script('elasticStackHelper', get_template_directory_uri() . '/js/elasticStackHelper.js', array('elasticStack'));
    }
}
